# Simple Shell
A collaboration project in c language on the implementation of a simple shell
...
* C language
* Shell
## ALX Requirements for the Project
...
## Description
hsh is a simple UNIX command language interpreter that allows users to enter commands interactively or non-interactively.
